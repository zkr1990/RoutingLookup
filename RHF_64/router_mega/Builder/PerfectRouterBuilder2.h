//---------------------------------------------------------------------------
#ifndef PerfectRouterBuilder2H
#define PerfectRouterBuilder2H
//---------------------------------------------------------------------------
#include <stdint.h>
#include <assert.h>
#include <string.h>
...
public:
	...
	bool Build(int *pn,uint64_t *hash,int nHash,int nBucket=0,int nSlot=400);
	bool Write(const char *fileName);

	void CopyIfBetter(TPerfectRouterBuilder2 &o);
};
#pragma pack(pop)
//---------------------------------------------------------------------------
