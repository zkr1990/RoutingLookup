...
bool generateFunction1(const char *funcFileName, uint64_t *hash, int *pn,int nHash)
{
...
bool generateFunction2(const char *funcFileName, uint64_t *hash, int *pn,int nHash)
{
    // // start with maximum number of buckets
    // int bucketStart = 16384;
    ...
    // int nSlotEnd = 1024;
    // start with maximum number of buckets
    int bucketStart = 65536;
    int bucketEnd = 65536; // this number must be larger than 4
    // start with   minimum number slots
    int nSlotStart = 2048;
    int nSlotEnd = 2048;
    ...
    myB.Close();
    fprintf(stderr,"bestBucketSize: %d, bestSlotSize: %d\r\n", bestBucketSize, bestSlotSize);
    fprintf(stderr,"bit memory cost = %d bit x nSlot + 8 bit x nBucket = %d \r\n", slotWidth, minCost);
...
bool generateFunction3(const char *funcFileName, uint64_t *hash, int *pn,int nHash)
{
    // // start with maximum number of buckets
    // int bucketStart = 16384;
    // int bucketEnd = 2048; // this number must be larger than 4
