//---------------------------------------------------------------------------
#ifndef PerfectRouterBuilder3H
#define PerfectRouterBuilder3H
//---------------------------------------------------------------------------
#include <stdint.h>
#include <assert.h>
#include <string.h>
...
public:
	...
	void CopyIfBetter(TPerfectRouterBuilder3 &o);
};
#pragma pack(pop)
//---------------------------------------------------------------------------
