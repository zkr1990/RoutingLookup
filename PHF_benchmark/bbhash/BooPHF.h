...
///// begin progress bar 确认目前generator的progress到哪里
class Progress
{
public:
	std::string   message;
...
///// end progress bar 确认目前generator的progress到哪里


//// begin 哈希生成器HashFunctor 类，根据key的index给出hash seed，并采用哈希函数
////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark hasher
////////////////////////////////////////////////////////////////
...
//// end 哈希生成器HashFunctor 类，根据key的index给出hash seed，并采用哈希函数
...
//// begin bit array 例如：每一级的A和C，每个元素代表某个key是否成功哈希的标志
////////////////////////////////////////////////////////////////
#pragma mark -
...
//// end bit array 例如：每一级的A和C，每个元素代表某个key是否成功哈希的标志



//// level 类，包含：
// 对应的bit Array A (bitVector)
// get函数输入key，找到hash_domain后，能得到A中的标志位信息(是否已经成功哈希)
////////////////////////////////////////////////////////////////
#pragma mark -
#pragma mark level
////////////////////////////////////////////////////////////////
...
//// 针对某一个args（包括iterator 和 要处理的range）
// 线程处理某一个level
////////////////////////////////////////////////////////////////
#pragma mark -
